/**
 * SSR / no-JS HTML body check script
 * Uses STATIC_DIR env when set; defaults to ./static from project root.
 *
...
const PATH_TO_STATIC: Record<string, string> = {
  '/': 'homepage.html',
  '/recentfollow-vs-followspy': 'recentfollow-vs-followspy.html',
  '/story-viewer': 'story-viewer.html',
  '/tiktok-competition': 'tiktok-competition.html',
  '/plans': 'plans.html',
}
